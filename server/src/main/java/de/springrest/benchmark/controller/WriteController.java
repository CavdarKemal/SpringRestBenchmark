 ...
 *
 * <p>Jede Stufe bekommt einen eigenen Pfad unterhalb von {@code /api/write}, damit der Client sie einzeln ansteuern und messen kann. Die Bulk-Stufen (ab W1) leeren die
 * Tabelle vor dem Lauf (nicht Teil der gemessenen Zeit) und liefern die reine Insert-Zeit im {@link BenchmarkResult}-Envelope zurueck.</p>
 */
@RestController
...
public class WriteController {
     ...
     * Der Client ruft diesen Endpoint in einer Schleife auf — ein HTTP-Request je Zeile.
     */
    @PostMapping("/w0")
    ...
    /**
     * <strong>W1 — Bulk-Payload, Einzel-INSERT, Autocommit.</strong> Alle Zeilen in einem Request; der Server speichert sie einzeln mit je eigenem Commit.
     */
    @PostMapping("/w1")
