 ...
 *
 * <p>Eine einzelne zu speichernde Messung. Der Client schickt in W0 pro Zeile genau ein solches Objekt (ein HTTP-Request je Zeile), spaeter ganze Listen davon.</p>
 *
 ...
 */
public record MeasurementRequest( OffsetDateTime ts, int sensorId, String category,
                                  double v1, double v2, double v3, double v4, double v5, double v6, double v7, double v8, String payload) {
    ...
    public Measurement toEntity() {
        ...
        return new Measurement(effectiveTs, sensorId, category, v1, v2, v3, v4, v5, v6, v7, v8, payload);
    }
}
